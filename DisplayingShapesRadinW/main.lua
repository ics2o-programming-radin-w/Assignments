...
myParallelogram:setStrokeColor(0, 0, 0)
...
myTrapazoid:setStrokeColor(0, 0, 0)
myTrapazoid.strokeWidth = 10
textObject = display.newText("Trapazoid", 200, 550, nil, 50 )
...
textObject = display.newText("Octagon", 350, 600, nil, 50 )